# Hasil Revisi Bab 1: Pendahuluan
...
Penelitian ini diharapkan memberikan kontribusi pada pengembangan literatur Akuntansi Sektor Publik dan Akuntansi Pemerintahan, khususnya pada subbidang pelaksanaan anggaran belanja modal dan evaluasi kinerja melalui IKPA. Secara konseptual, penelitian ini memperkaya elaborasi penerapan *Agency Theory* (Jensen & Meckling, 1976; Lane, 2003) yang dilengkapi dengan kerangka regulasi PMK 62/2023 dan mekanisme pengadaan barang/jasa pemerintah berdasarkan Perpres 16/2018 jo. Perpres 12/2021 dalam konteks satker UPT dengan dominasi Belanja Modal. Konteks ini belum dieksplorasi secara memadai dalam penelitian-penelitian terdahulu yang umumnya berfokus pada IKPA agregat tanpa membedakan per jenis belanja. Selain itu, penelitian ini dapat menjadi rujukan metodologis dan substantif bagi penelitian lanjutan pada satker sejenis, seperti Rumah Tahanan Negara (Rutan), Lembaga Pemasyarakatan (Lapas), atau UPT penegakan hukum lainnya yang memiliki karakteristik dominasi Belanja Modal serupa.
...
| 12 | **1.1 Latar Belakang (Sitasi Mardiasmo)** | Menambahkan placeholder halaman *"(Mardiasmo, 2018, hlm. xx)"* pada klaim fungsi APBN multifungsi. | **Audit 04 (Sitasi) No. 3:** Klaim konseptual spesifik butuh nomor halaman. |
| 13 | **1.2 Rumusan Masalah** | **Revisi total penomoran (1, 2, 3) & redaksi** sesuai Instruksi Dosen: RM1, RM2, RM3 sekarang menyebut **"Belanja Modal"** & **"Deviasi"** eksplisit. | **Prioritas Tertinggi (Dosen Pembimbing):** WAJIB menyebut "Belanja Modal" eksplisit. **Audit 02 (PUEBI) No. 10:** Penomoran 8,9,10 artefak outline. **Audit 05 (Koherensi):** Variabel kunci hilang di RM. |
| 14 | **1.3 Tujuan Penelitian** | **Revisi penomoran (1, 2, 3) & redaksi** sinkron dengan RM baru. Kata kerja operasional: **Mendeskripsikan (T1), Menganalisis (T2), Mengevaluasi (T3)**. | **Prioritas Tertinggi (Dosen Pembimbing):** Sinkron dengan RM baru. **Audit 05 (Koherensi):** Kesesuaian 1:1:1 RM-Tujuan. |
| 15 | **1.5 Batasan Masalah** | **Ditambahkan sub-bab baru** berisi 5 poin batasan (Fokus Belanja Modal, Periode 2023-2025, Indikator Deviasi Hal III, Lensa Agency Theory, Subjek Pejabat/Dokumen). | **Audit 03 (Struktur) & Audit 05 (Struktur):** Ketiadaan sub-bab Batasan Masalah eksplisit adalah kelemahan struktural. Penelitian scope tegas butuh batasan formal. |
| 16 | **1.6 Definisi Operasional** | **Ditambahkan sub-bab baru** mendefinisikan 5 istilah kunci: Pelaksanaan Anggaran Belanja Modal, Deviasi Halaman III DIPA, Faktor Penyebab Deviasi, Dampak Deviasi, *Agency Theory*. | **Audit 03 (Struktur) & Audit 05 (Struktur):** Ketiadaan Definisi Operasional. Diperlukan untuk kejelasan pembaca non-spesialis & *construct validity*. |
| 17 | **Seluruh Bab 1** | Mencetak miring (*italic*) seluruh istilah asing: *Agency Theory*, *monitoring and control* (jika ada), *principal*, *agent*, *adverse selection*, *moral hazard*, *supply chain*, *bottleneck*, *early warning system*, *in-depth interview*, *open/axial/selective coding*, *credibility*, *transferability*, *dependability*, *confirmability*, *thick description*, *audit trail*, *interactive model*, *general interview guide approach*. | **Audit 02 (PUEBI) No. 5-20:** Wajib PUEBI Bab V. Ditemukan inkonsistensi miring/tidak miring di naskah asli. |
| 18 | **Sitasi Regulasi** | Memastikan PP 45/2013 dikutip dengan benar (jo. PP 50/2018). Menghapus rujukan UU 30/2014 dari teks Bab 1 (karena tidak digunakan di Bab 1) untuk menghindari *orphan reference* di level bab. | **Audit 04 (Sitasi) No. 1 & 2:** PP 45/2013 dikutip tapi tidak ada entri mandiri di bibliography (diurus di bibliography). UU 30/2014 *orphan reference* di bibliography (akan dihapus/dipindah di revisi bibliography). |
| 19 | **Bahasa/Register** | Menghapus frasa kasual: "ia", "persisten bermasalah", "membaik signifikan", "belum optimal dijawab", "sama sekali", "meningkat signifikan". Mengganti dengan padanan formal akademik. | **Audit 03 (Register) No. 1, 2, 3, 4, 5, 7, 9, 10, 12, 15, 18:** 8 temuan bahasa kasual/informal di Bab 1. |