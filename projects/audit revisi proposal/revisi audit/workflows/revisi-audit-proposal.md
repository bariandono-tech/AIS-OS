...
2. **Tahap Paralel (Stage 2 & 3):**
   ...
   - Menjalankan `workflows/stages/02-audit-puebi.md` (Pengecekan ejaan, format, dan tata bahasa).
   - Menjalankan `workflows/stages/03-audit-struktur-dan-sitasi.md` (Pengecekan alur bab, logika argumen, dan kesesuaian sitasi proposal).
   - Kedua stage ini bersifat *independent* satu sama lain dan dijalankan paralel jika memungkinkan.

3. **Tahap Konsolidasi (Stage 4):**
   - Menjalankan `workflows/stages/04-final-report.md`.
