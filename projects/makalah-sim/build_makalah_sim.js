...
function insertFlowchartImage(imageName, figNum, title, targetWidth = 300, dummyHeight = null) {
  ...
  return [
    ...
    centered(`Gambar ${figNum}. ${title}`, { size: 22, spaceAfter: 80 }),
  ...
  sections: [
    ...
    // ═══════════════════════════════════════════════════════════════
    {
      ...
      children: [
        ...
        tocEntry('KATA PENGANTAR', 'i', 0, true),
        tocEntry('DAFTAR ISI', 'ii', 0, true),
        tocEntry('BAB I PENDAHULUAN', '1', 0, true),
        tocEntry('A. Latar Belakang', '1', 1, false),
        tocEntry('B. Rumusan Masalah', '3', 1, false),
        tocEntry('C. Tujuan Penulisan', '3', 1, false),
        tocEntry('BAB II PEMBAHASAN', '4', 0, true),
        tocEntry('A. Struktur Organisasi Rumah Detensi Imigrasi Pontianak', '4', 1, false),
        tocEntry('B. Sistem Informasi Manajemen Keimigrasian (SIMKIM)', '7', 1, false),
        tocEntry('C. Standar Operasional Prosedur (SOP) Rudenim Pontianak', '10', 1, false),
        tocEntry('D. Analisis Integrasi Struktur, SIMKIM, dan SOP', '15', 1, false),
        tocEntry('BAB III PENUTUP', '18', 0, true),
        tocEntry('A. Kesimpulan', '18', 1, false),
        tocEntry('B. Saran', '19', 1, false),
        tocEntry('DAFTAR PUSTAKA', '20', 0, true),
      ]
    },
    // ═══════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════
    {
      ...
      children: [
        ...
        centered('PEMBAHASAN', { bold: true, size: 24, spaceAfter: 240 }),
        ...
        centered('Gambar 1. Struktur Organisasi Rudenim Pontianak', { size: 22, spaceAfter: 240 }),
        ...
        centered('Gambar 2. Flowchart Siklus Hidup Deteni Terintegrasi dengan 7 SOP', { size: 22, spaceAfter: 80 }),
        centered('pada Rumah Detensi Imigrasi Pontianak', { size: 22, spaceAfter: 240 }),
        tableSource('Sumber: Perdirjen Imigrasi No. IMI.1917-OT.02.01/2013, diolah peneliti (2026).'),
        ...
        ...insertFlowchartImage('sop_penerimaan_flowchart.png', '2.1', 'Flowchart SOP Penerimaan Calon Deteni', 450, 354),
        tableCaptionCentered('Tabel 2.1. Mutu Baku SOP Penerimaan Calon Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_kesehatan_flowchart.png', '2.2', 'Flowchart SOP Pemeriksaan Kesehatan Deteni', 380, 517),
        tableCaptionCentered('Tabel 2.2. Mutu Baku SOP Pemeriksaan Kesehatan Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_registrasi_flowchart.png', '2.3', 'Flowchart SOP Registrasi Deteni', 450, 315),
        tableCaptionCentered('Tabel 2.3. Mutu Baku SOP Registrasi Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_penempatan_flowchart.png', '2.4', 'Flowchart SOP Penempatan Deteni Ke Blok Hunian', 450, 415),
        tableCaptionCentered('Tabel 2.4. Mutu Baku SOP Penempatan Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_penjagaan_flowchart.png', '2.5', 'Flowchart SOP Penjagaan & Pengamanan Rudenim', 450, 315),
        tableCaptionCentered('Tabel 2.5. Mutu Baku SOP Penjagaan & Pengamanan Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_pemindahan_flowchart.png', '2.6', 'Flowchart SOP Pemindahan Deteni Antar Rudenim', 380, 560),
        tableCaptionCentered('Tabel 2.6. Mutu Baku SOP Pemindahan Deteni'),
        createMutuBakuTable([
        ...
        ...insertFlowchartImage('sop_deportasi_flowchart.png', '2.7', 'Flowchart SOP Pendeportasian Deteni Ke Negara Asal', 380, 560),
        tableCaptionCentered('Tabel 2.7. Mutu Baku SOP Pendeportasian Deteni'),
        createMutuBakuTable([
        ...
        centered('Gambar 3. Kerangka Analisis Leavitt\'s Diamond Model', { size: 22, spaceAfter: 80 }),
        centered('pada Rumah Detensi Imigrasi Pontianak', { size: 22, spaceAfter: 240 }),
        ...
        // Tabel Keterkaitan
        tableCaptionCentered('Tabel 1. Matriks Keterkaitan Antar Elemen Leavitt\'s Diamond'),
        new Table({
    ...
    // ═══════════════════════════════════════════════════════════════
    {
      ...
      children: [
        ...
        centered('PENUTUP', { bold: true, size: 24, spaceAfter: 240 }),
...
Packer.toBuffer(doc).then((buffer) => {
  const outputPath = path.join(__dirname, 'MAKALAH_SIM_AJIE_BARIANDONO_2110426823.docx');
  fs.writeFileSync(outputPath, buffer);
  console.log(`✅ Document berhasil dibangun: ${outputPath}`);
  console.log(`   Struktur: 3 BAB (Pendahuluan, Pembahasan, Penutup)`);
