...
description: >
  ...
  Notion workspace homepage into the "Ultimate Brain" three-column style —
  ...
  - Making Notion look like the Ultimate Brain template
  ...
  - Phrases like "ubah tampilan Notion", "bikin seperti Ultimate Brain", "redesign homepage Notion",
    "buat prompt Notion baru", or "update layout Ultimate Brain"
---

# Notion Homepage Redesign — Ultimate Brain Style

## What this skill produces

Two deliverables for every run:

1. **A ready-to-paste Notion prompt** — detailed, block-by-block instructions the user can follow (or give to Notion AI) to rebuild their homepage in the Ultimate Brain three-column layout.
...
The "Ultimate Brain" homepage uses this structure:
...
If the user has already shared their page list (e.g. from a sidebar screenshot), use their actual page names and emojis. Otherwise use the Ultimate Brain defaults shown above.
...
If the user's workspace differs from the Ultimate Brain defaults:
